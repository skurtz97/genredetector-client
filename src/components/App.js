    ...
    <div className="App">
      <Flex direction="column" marginTop={4}>
        <Stack direction="column" spacing={12} w="90%" margin="0 auto">
          ...
          <Text textAlign="left">{`Server found ${total} results and sent ${length} to client. It took ${elapsed.toFixed(
            0
          )}ms to receive a response.`}</Text>
